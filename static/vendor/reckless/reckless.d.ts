...
export class Engine {
    ...
    go_movetime_searchmoves(ms: number, multi_pv: number, search_moves: string, on_info?: Function | null): void;
    go_uci(depth: number, nodes: number, multi_pv: number, on_info?: Function | null): void;
    go_uci_searchmoves(depth: number, nodes: number, multi_pv: number, search_moves: string, on_info?: Function | null): void;
...
export interface InitOutput {
    ...
    readonly engine_go_uci_searchmoves: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly engine_go_movetime_searchmoves: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
